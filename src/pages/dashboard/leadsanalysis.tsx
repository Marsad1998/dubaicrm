...
//                                     <div className={`flex items-center justify-center w-12 h-12 rounded-full ${statusInfo.bgColor}`} style={{ color: statusInfo.color }}>
    ...
    return (
        <div>
            ...
            <div className="pt-5">
                ...
                <div className="grid sm:grid-cols-2 xl:grid-cols-5 gap-6 mb-6">
                    <div className="panel h-full p-0 rounded-md shadow-md bg-secondary">
                        <div className="flex flex-col items-center justify-center p-6 h-full">
                            <div className="flex items-center justify-center w-14 h-14 rounded-full bg-white/20 mb-4">
                                <IconChecks className="w-7 h-7 text-white" />
                            </div>
                            <h3 className="text-xl font-bold text-white mb-2">Lead Dashboard</h3>
                            <p className="text-white/80 text-center text-sm mb-4">Detailed analytics & insights</p>
                            <Link to="/pages/leads/dashboard2" className="inline-flex items-center justify-center px-4 py-2 bg-white text-blue-600 font-semibold rounded-sm hover:bg-blue-50 transition-all duration-200 text-sm shadow-md hover:shadow-lg">
                               Open Dashboard
                            </Link>
                        </div>
                    </div>
                    {Object.entries(leadsData.percentages).map(([statusNumber, percentage], index) => {
                        ...
                        return (
                            ...
                            <div key={statusNumber} className="panel h-full p-0 rounded-md shadow-md bg-white dark:bg-gray-900">
                                <div className="flex items-center p-5">
                                    <div 
