...
const ConfigSettings = () => {
    ...
    const { templates, loadingg, selectedTemplateId, setSelectedTemplateId, selectedTemplate, preview, previewLoading } = useTemplates();
                    ...
                    <>
                        <div>
                            <ul className="sm:flex font-semibold border-b border-[#ebedf2] dark:border-[#191e3a] mb-5 whitespace-nowrap overflow-y-auto">
                                ...
                                <li className="inline-block">
                                    <button
                                        onClick={() => toggleTabs('ThemeLayout')}
                                        className={`flex gap-2 p-4 border-b border-transparent hover:border-primary hover:text-primary ${tabs === 'smtp' ? '!border-primary text-primary' : ''}`}
                                    >
                                        <IconServer />
                                        Theme Layout
                                ...
                                <li className="inline-block">
                                    <button
                                        onClick={() => toggleTabs('campaign_agents')}
                                        className={`flex gap-2 p-4 border-b border-transparent hover:border-primary hover:text-primary ${tabs === 'smtp' ? '!border-primary text-primary' : ''}`}
                                    >
                                        <IconServer />
                                        Campaign And Agents
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        ...
                                        <div>
                                            ...
                                            <input id="smtp_port" name="smtp_port" type="number" placeholder="587" className="form-input" value={formData.smtp_port} onChange={handleInputChange} />
                                        ...
                                        <div>
                                            ...
                                            <select id="smtp_encryption" name="smtp_encryption" className="form-select" value={formData.smtp_encryption} onChange={handleInputChange}>
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        <div className="mt-4 flex flex-col sm:flex-row gap-4">
                                            <label
                                                className={`flex items-center gap-3 cursor-pointer rounded-lg border px-5 py-5 transition 
                                                ${formData.theme_layout === 1 ? 'border-primary bg-primary/10 text-primary' : 'border-gray-300 hover:border-primary/50 dark:border-gray-600'}`}
                                            >
                                                <input
                                                    type="radio"
                                                    name="theme_layout"
                                            ...
                                            <label
                                                ...
                                                ${formData.theme_layout === 0 ? 'border-primary bg-primary/10 text-primary' : 'border-gray-300 hover:border-primary/50 dark:border-gray-600'}`}
                                            >
                                                <input
                                                    type="radio"
                                                    name="theme_layout"
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-9 gap-6 mb-8">
                                        <div className="md:col-span-2 flex flex-col gap-2">
                                            ...
                                            />
                                            {errors.campaign_names && <span className="text-red-500 text-sm">{errors.campaign_names}</span>}
                                        </div>
                                        <div className="md:col-span-2 flex flex-col gap-2">
                                            ...
                                            <Select
                                                ...
                                                isMulti
                                            />
                                            {errors.agent_ids && <span className="text-red-500 text-sm">{errors.agent_ids}</span>}
                                        </div>
                                        <div className="md:col-span-2 flex flex-col gap-2">
                                            <label htmlFor="sid">WhatsApp Template</label>
                                            <Select
                                                value={
                                                    selectedTemplate
                                                        ? {
                                                              value: selectedTemplate.id,
                                                              label: selectedTemplate.friendly_name,
                                                          }
                                                        : null
                                                }
                                                ...
                                                onChange={(option: any) => {
                                                    ...
                                                    setFormData((prev) => ({ ...prev, template_id: templateId, sid: templates.find(t => t.id === templateId)?.sid || ''
                                                    }));
                                                }}
                                                name="sid"
                                            />
                                            ...
                                            <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-4">
                                                ...
                                                <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 min-h-[100px]">
                                                    {previewLoading ? (
                                                        ...
                                                        <>
                                                            <div className="text-xs text-slate-400 mb-1">{selectedTemplate.friendly_name}</div>

                                                            <pre className="text-sm whitespace-pre-wrap text-slate-700 leading-6">
                                                                {typeof preview === 'string' ? preview : preview?.body || 'No preview available'}
                                                            </pre>

                                                            {typeof preview !== 'string' && preview?.media && <img src={preview.media} alt="media" className="rounded-lg mt-3" />}
                                                        </>
                                                    ) : (
                                                        <p className="text-sm text-slate-500">Select a template to see preview.</p>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                {campaignAgents && campaignAgents.length > 0 ? (
                                                    campaignAgents.map((assignment) => (
                                                        <tr key={assignment.id} className="border-t hover:bg-gray-50">
                                                            <td className="px-4 py-3 text-sm">{assignment.campaign_name}</td>
                                                            <td className="px-4 py-3 text-sm">{assignment.agents?.client_user_name || 'N/A'}</td>
                                                            <td className="px-4 py-3 text-sm">{assignment.agents?.client_user_email || 'N/A'}</td>
                                                            <td className="px-4 py-3 text-sm">
                                                                <button type="button" onClick={() => handleDeleteAssignment(assignment.id)} className="text-red-500 hover:text-red-700">
